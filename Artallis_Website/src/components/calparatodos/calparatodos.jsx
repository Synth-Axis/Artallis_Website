        ...
        <div className="text-container">
          <div className="text-content">
            <p>
              ...
              plataformas e iniciativas em que toda a comunidade pode participar
              e ajudar.
            </p>
            <p>
          ...
          <div className="text-content">
            <p>
              ...
              participação não se limitam apenas aos projetos já em andamento. O
              Artallis está sempre aberto a novas propostas e iniciativas, e
              incentiva a criatividade e o empreendedorismo entre os membros da
              comunidade escolar.
            </p>
            <p>
              Em suma, este espaço serve como um ponto de encontro e divulgação
              das atividades desenvolvidas pelo Artallis, bem como um convite
              aberto à participação e colaboração de todos os interessados em
              contribuir para o enriquecimento da vida escolar e comunitária.
            </p>
            <p>
