      ...
      <div className="historia-container">
        ...
        <div className="conteudo-grid">
          ...
          <div className="txt-section">
            ...
            <p>
              ...
              cursos desde a infância até ao ensino secundário. A sua abordagem
              única e centrada nas artes, no apoio objetivo e cultivar o talento
              artístico de cada aluno, proporcionando uma educação abrangente e
              de elevada qualidade.
            </p>
            <p>
              É com grande satisfação que informamos que o Artallis é
              reconhecido pelo Ministério da Educação (MEC), atestando a
              qualidade do nosso ensino e o compromisso sério com a nossa missão
              educativa. Além disso, temos o privilégio de contar com parcerias
              internacionais de renome, como a Trinity Guide Hall, ABRSM e Royal
              Ballet. Estas colaborações permitem-nos enriquecer ainda mais a
              experiência dos nossos alunos, oferecendo oportunidades únicas de
              aprendizagem e crescimento artístico.
            </p>
            <p>
            ...
            <p>
              ...
              excelência e inovação. Acreditamos que a arte desempenha um papel
              crucial na sociedade, transcendendo fronteiras e enriquecendo
              vidas. No Conservatório Artallis, procuramos despertar a paixão
              pela arte em cada aluno, incentivando a expressão criativa, a
              busca pela excelência e o desenvolvimento integral.
            </p>
            <p>
        ...
        <div className="historia-info">
          <div>
            ...
            <p>
              Juntem-se a nós no Conservatório Artallis, onde o talento floresce
