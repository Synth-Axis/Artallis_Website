        ...
        <div className="historia-container">
          ...
          <div>
            <div className="title-grid">
              <h2>Um Refúgio para a Expressão Artística</h2>
            </div>
            <div className="conteudo-grid">
              ...
              <div className="txt-section">
                <p>
                  Bem-vindos ao Conservatório Artallis! Hoje, vamos embarcar
                  numa viagem pela história desta notável instituição, fundada
                  em 21 de outubro de 2008. Apesar de ser uma escola recente, o
                  Artallis já conquistou um lugar de destaque no panorama
                  nacional, sendo reconhecido pela qualidade pedagógica,
                  excelência artística e inovação que o caracterizam.
                </p>
                <p>
                  Desde os seus primórdios, o Conservatório Artallis
                  distinguiu-se como uma escola de ensino especializado em
                  artes, oferecendo cursos desde a infância até ao ensino
                  secundário. A sua abordagem única e centrada nas artes, no
                  apoio objetivo e cultivar o talento artístico de cada aluno,
                  proporcionando uma educação abrangente e de elevada qualidade.
                </p>
                <p>
                  ...
                  ABRSM e Royal Ballet. Estas colaborações permitem-nos
                  enriquecer ainda mais a experiência dos nossos alunos,
                  oferecendo oportunidades únicas de aprendizagem e crescimento
                  artístico.
                </p>
                <p>
                  Atualmente, sentimos orgulho em afirmar que o Conservatório
                  Artallis conta com cerca de quinze mil alunos, tornando-nos na
                  maior escola de ensino especializado em artes em Portugal.
                  Este número expressivo é o resultado da confiança depositada
                  na nossa instituição pela comunidade, inspirando-nos a
                  continuar a aprimorar o nosso trabalho.
                </p>
                <p>
                  ...
                  expressão criativa, a busca pela excelência e o
                ...
                <p>
                  No Conservatório Artallis, acreditamos no poder transformador
                  da arte. Procuramos moldar os artistas do futuro, mas também
